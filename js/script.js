 ...
 document.getElementById("calculate").addEventListener("click", function () {
    ...
    if (bmi < 18.5) {
        ...
        bmiStatus.textContent = "Berat badan normal (ideal)";
        bmiValueBottom.textContent = "Hasil BMI diantara 18.5 dan 24.9";
        bmiAdvice.textContent = "Anda berada dalam kategori berat badan yang normal. Tetap pertahankan berat badan Anda dan jaga berat badan Anda dengan mengatur keseimbangan pola makan dan aktivitas fisik Anda.";
